...
@Repository
public class ConsumablesInventoryFilterImpl implements ConsumablesInventoryFilter {
	@Autowired
	private MongoTemplate mongoTemplate;

	@Override
	public List<ConsumablesInventory> findConsumablesInventoryWithFilter(List<String> categoryList, String desc) {
...
//		}
		...
		return mongoTemplate.find(query, ConsumablesInventory.class);
	}
	...
	public void updateCategory(String oldCategory, String newCategory) {
	    ...
	    mongoTemplate.updateMulti(query, update, ConsumablesInventory.class);
	}
