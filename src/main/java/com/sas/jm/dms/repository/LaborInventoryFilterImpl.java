...
@Repository
public class LaborInventoryFilterImpl implements LaborInventoryFilter {
	@Autowired
	private MongoTemplate mongoTemplate;

	@Override
	public List<LaborInventory> findLaborInventoryWithFilter(List<String> categoryList, String desc) {
...
//		}
		...
		return mongoTemplate.find(query, LaborInventory.class);
	}
